...
<head>
    ...
    <link href="mainnn.css" rel="stylesheet" />
...
<body>
    ...
    <div class="s007">
        ...
        <form action="resultat_de_recherche.jsp" method="post">

            <div class="inner-form">
                <h1 style=>Cherchez vous  emploi?</h1>
                <div class="basic-search">
                  ...
                  <path
                        ...
                        <input id="search" type="text" name="search"  placeholder="rechercher par nom d'entreprise..." /> </input>
                        <div class="result-count">
                        
                            <span>108 </span>resultats
                        </div>
                    </div>
                </div>
